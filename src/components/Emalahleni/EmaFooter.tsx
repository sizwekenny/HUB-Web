...
const Footer: React.FC = () => {
  const quickLinks = [
    ...
    {
      name: 'Location',
      url: 'https://maps.app.goo.gl/BbTJBogD4EJcSmwi7',
  ...
  return (
    <footer className="relative overflow-hidden text-center md:text-left py-12 bg-red-600 text-white mt-16" style={{ marginTop: '0px' }}>
